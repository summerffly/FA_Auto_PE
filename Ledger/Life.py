...
class LifeLedger(BaseLedger):
    ...
    def sync_month_line(self, month_no: str, key: str, target_value: int):
        ln = self.get_month_line(month_no, key)
        ln.value = target_value

    def checksync_month_line(self, month_no: str, key: str, expected_value: int) -> bool:
        ln = self.get_month_line(month_no, key)
        return ln.value == expected_value
